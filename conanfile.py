...
class GodotCppConan(ConanFile):
    ...
    def source(self):
        ...
        self.run("cd godot-cpp && git checkout e4ad265339f17042a86227bfb44f9d5d7dee5ba4 && cd ..")
        self.run("git clone https://github.com/GodotNativeTools/godot_headers.git godot-cpp/godot_headers")
        self.run("cd godot-cpp/godot_headers && git checkout 98ee82599dfe07e17983ad831f5e9ac41068667f && cd ../..")
